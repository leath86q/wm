...
#if BAR_ALPHA_PATCH
static const unsigned int baralpha = 0xf2;  /* 95% opacity */
...
static const char *dmenucmd[] = {
	...
	"-sb", selbgcolor,
	"-sf", selfgcolor,
	"-hp", "st,librewolf,firefox,code,thunar,pcmanfm,htop,nvim,vim",
